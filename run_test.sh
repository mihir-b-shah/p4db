...
if [[ "$2" == "DBG" ]]
then
	gdb --args ./build/p4db --node_id $1 --num_nodes 2 --num_txn_workers 1 --use_switch=true --num_txns 1000000 --write_prob 100 --table_size 10000000 --trace_fname="generator/node$1_S2_z99_N1000000_n8_k10000000_txns.csv" --dist_fname="generator/dist_S2_z99_N1000000_n8_k10000000.txt"
else
	./build/p4db --node_id $1 --num_nodes 2 --num_txn_workers 1 --use_switch=true --num_txns 1000000 --write_prob 100 --table_size 10000000 --trace_fname="generator/node$1_S2_z99_N1000000_n8_k10000000_txns.csv" --dist_fname="generator/dist_S2_z99_N1000000_n8_k10000000.txt" 2>logs/log_$1
fi
