...
then
	...
	time ./build/p4db --tenant_id 0 --node_id $1 --num_nodes 2 --num_txn_workers 3 --use_switch=true --num_txns 1000000 --write_prob 100 --table_size 10000000 --trace_fname="generator/node$1_S2_z99_N1000000_n8_k10000000_txns.csv" --dist_fname="generator/dist_S2_z99_N1000000_n8_k10000000.txt" #2>logs/log_$1
fi
