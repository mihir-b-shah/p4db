...
./build/p4db --node_id $1 --num_nodes 2 --num_txn_workers 2 --use_switch=false --num_txns 500000 --write_prob 100 --hot_size 1000 --table_size 10000000 --trace_fname="generator/node$1_z80_N100000_n16_k10000000_h100_c0_txns.csv"
